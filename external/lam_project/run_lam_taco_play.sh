...
mkdir -p slurm_outputs/lam_taco_play
mkdir -p exp_ckpts_taco_play
mkdir -p exp_imgs_taco_play
...
echo "Config: config/lam_taco_play.yaml"
...
torchrun \
    ...
    main.py fit \
    --config config/lam_taco_play.yaml \
    --data.num_workers=4 \
