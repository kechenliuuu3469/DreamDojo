...
#     --nproc_per_node=8 \
#     main.py fit \
#     --config config/lam_bridge_droid_full_vertical.yaml \
#     --data.num_workers=4 \
#     --pretrained_ckpt /n/fs/geniemodel/DreamDojo/checkpoints/LAM/LAM_400k.ckpt
...
torchrun \
    ...
    --config config/lam_bridge_droid_full_vertical.yaml \
    --data.num_workers=4 \
    --ckpt_path /n/fs/geniemodel/DreamDojo/external/lam_project/exp_ckpts_bridge_droid_full_vertical/last.ckpt
