...
mkdir -p slurm_outputs/lam_roboturk
mkdir -p exp_ckpts_roboturk
mkdir -p exp_imgs_roboturk
...
echo "Config: config/lam_roboturk.yaml"
...
torchrun \
    ...
    main.py fit \
    --config config/lam_roboturk.yaml \
    --data.num_workers=4 \
