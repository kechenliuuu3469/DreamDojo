...
mkdir -p slurm_outputs/lam_fractal
mkdir -p exp_ckpts_fractal
mkdir -p exp_imgs_fractal
...
echo "Config: config/lam_fractal.yaml"
...
torchrun \
    ...
    main.py fit \
    --config config/lam_fractal.yaml \
    --data.num_workers=4 \
